function love.load()
    ...
    mouse.y = 0
    --]]--
    serverGame = ServerGame:new(server_id) -- create game
    serverSocket = ServerSocket:new() -- create socket
    serverSocket:create() -- create recieving socket
